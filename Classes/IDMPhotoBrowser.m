...
{
    if ([self.delegate respondsToSelector:@selector(photoBrowser:wantsToDeleteAtIndex:)]) {
        [self.delegate photoBrowser:self wantsToDeleteAtIndex:_currentPageIndex];
    }
}

- (void)actionButtonPressed:(id)sender
{
    if ([self.delegate respondsToSelector:@selector(photoBrowser:wantsToShareAtIndex:)]) {
        [self.delegate photoBrowser:self wantsToShareAtIndex:_currentPageIndex];
    }
    return;
